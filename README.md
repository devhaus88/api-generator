...
| **Gerenciador de Templates** | Crie modelos dinâmicos via tags com a quantidade de arquivos que desejar |
| **Seleção de Template por API** | Especifique qual template será utilizado para cada tabela carregada |
...
| **Download ZIP** | Arquivos prontos para extrair na pasta do projeto |
...
| **V2.0** ✅ | Salvar/carregar templates (localStorage), criação de templates customizados |

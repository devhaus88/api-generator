...
### V2.0 (Planejado)
- Persistência de APIs salvas (localStorage) — histórico de templates
- Importar `.i` existente para editar API já criada
- Suporte a múltiplas tabelas (JOIN) numa mesma API
